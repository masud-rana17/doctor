...
import footer from '../../doctors-portal/assets/images/footer.png'

const Footer = () => {
    return (
        <div>
            <footer style={{ backgroundImage: `url(${footer})`, backgroundSize:'cover' } }>
                <div className="footer p-10 items-center text-zinc-600 ">
                    <div>
                    ...
                    <div>
                        <span to="/" className="footer-title">Legal</span>
                        <Link to="/" className="link link-hover">Terms of use</Link>
                        <Link to="/" className="link link-hover">Privacy policy</Link>
                        <Link to="/" className="link link-hover">Cookie policy</Link>
                    </div>
                </div>
                <div className='footer items-center p-4 text-cyan-600'>
